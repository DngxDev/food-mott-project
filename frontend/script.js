...
// Dòng 45 sửa lại thành:
btnHtml = `<button class="btn-add" onclick="addToCart(${food.id})" style="width: 100%; padding: 10px; background: #f39c12; color: white; border: none; border-radius: 5px; font-weight: bold;">Thêm vào giỏ</button>`;        // --- PHẦN MỚI: Cấu trúc lại HTML để chứa thẻ <img> ---
        card.innerHTML = `
